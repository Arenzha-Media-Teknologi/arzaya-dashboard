                    ...
                    >
                      <Box>
                        ...
                        <HStack alignItems="center">
                          <Heading color="#A8BCD4" size="md">
                            Periode{" "}
                            {dayjs(project?.period1 || null).format(
                              "MMMM YYYY"
                            )}
                          </Heading>
                          {Array.isArray(project?.section_names) &&
                            project?.section_names.map((sectionName) => (
                              <Badge fontSize="1em">{sectionName?.name}</Badge>
                            ))}
                        </HStack>
                      </Box>
                      <Badge
